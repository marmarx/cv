Vue.createApp({
  data: () => ({
    edited:{en:'Updated on Jan 13th, 2026',pt:'Atualizado em 13 de Janeiro de 2026'},
    base:{
      name:'Marco Martins',
    ...
    intro:{
      ...
      pt:'Adoro aprender coisas novas através do contato direto, enquanto crio, penso e faço. Fui administrador e engenheiro por 6 anos, e por outros 6 anos trabalhei no treinamento de IA e atendimento ao cliente. Agora quero ser desenvolvedor e/ou trabalhar com análise de big data e programação.'
    },
    languages:{
      en:[
    ...
    experiences:{
      en:[
        {name:'Volunteer - Phoenix Social Project',details:'Mar 2010 to Nov 2012 - Phoenix-USP Stundent Group'},
    ...
    achievements:{
      en:[
        ...
        {name:'Development of a system for Managing Private Lessons using Vue.js and Capacitor',span:' live at https://gestaodeaulas.netlify.app/'}
      ],
      pt:[
        ...
        {name:'Desenvolvimento de um sistema para Gestão de Aulas Particulares em Vue.js e Capacitor',span:' disponível em https://gestaodeaulas.netlify.app/'}
      ]
    }
  }),
  computed:{},
