  ...
  data: () => ({
    ...
    courses:{
      en:[
        ...
        {name:'Python Fundamentals + Intermediate Python',details:'2025 - Frontend Masters'},
      ...
      pt:[
        ...
        {name:'Fundamentos de Python + Python Intermediário',details:'2025 - Frontend Masters'},
