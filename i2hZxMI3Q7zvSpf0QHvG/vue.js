Vue.createApp({
  data: () => ({
    ...
    intro:{
      en:'I love to learn new things while brainstorming through tinkering (aka "thinkering"). I\'ve been an administrator and engineer for 6 years, and for another 6 years I worked in customer service. Now I want to be a developer and/or work in big data analysis.',
      pt:'Adoro aprender coisas novas através do contato direto, enquanto crio, penso e faço. Fui administrador e engenheiro por 6 anos, e por outros 6 anos trabalhei no atendimento ao cliente. Agora quero ser desenvolvedor e/ou trabalhar com análise de dados.'
    },
    languages:{
      en:[
    ...
    experiences:{
      en:[
        ...
        {name:'Partner - Consultant, Project Manager, Salles Representative and CFO',details:'May 2013 to Aug 2018 - Genos Environmental Consulting LTDA ME, São Carlos/SP, Brazil'},
      ...
      pt:[
        ...
        {name:'Sócio - Consultor, Gestor de Projetos, Representante de Vendas e CFO',details:'Mai 2013 a Ago 2018 - Genos Consultoria Ambiental LTDA ME, São Carlos/SP, Brasil'},
    ...
    courses:{
      en:[
        ...
        {name:'Node.js and MongoDB Atlas integrated to Google Gemini',details:'Alura (2024)'},
        ...
        {name:'Python Fundamentals + Intermediate Python',details:'Frontend Masters (2025)'},
      ...
      pt:[
        ...
        {name:'The hard parts of asynchronous JavaScript',details:'Frontend Masters (2024)'},
        {name:'The hard parts of functional JavaScript',details:'Frontend Masters (2024)'},
        {name:'Node.js e MongoDB Atlas integrado ao Google Gemini',details:'Alura (2024)'},
        ...
        {name:'Fundamentos de Python + Python Intermediário',details:'Frontend Masters (2025)'},
